...
void karte_t::create_valleys()
{
	...
	loadingscreen::set_label(translator::translate("creating valleys - copying world"));
...
//			tmp_world[(i*size_x)+j].z = lookup_hgt(koord(j,i));
	...
	loadingscreen::set_label(translator::translate("creating valleys - btfffa"));
...
//							lookup_kartenboden(next_k)->set_text(NULL);
	...
	loadingscreen::set_label(translator::translate("creating valleys - creating rivers"));
